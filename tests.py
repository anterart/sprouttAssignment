...
def test_get_questionnaire1():
    ...
    assert response.json() == {'customer': {'customer_id': 0, 'first_name': 'Leonidas', 'last_name': 'I', 'email': 'king@sparta.gr', 'phone': '123456', 'last_answers': {'0': {'question_id': 0, 'value': '50'}, '1': {'question_id': 1, 'value': 'yes'}, '2': {'question_id': 2, 'value': 'Term'}, '3': {'question_id': 3, 'value': '77777'}, '5': {'question_id': 5, 'value': 'no'}, '9': {'question_id': 9, 'value': 'Au! Au! Au!'}}}, 'questions': [{'question_id': 0, 'text': 'At what age do you plan to retire?', 'question_type': 'number', 'position': 0, 'options': [], 'follow_up_questions': [], 'is_follow_up': False, 'answer_value': '50', 'dropdown_data': None}, {'question_id': 1, 'text': 'Do you currently have any life insurance coverage?', 'question_type': 'yes_no', 'position': 1, 'options': [], 'follow_up_questions': [{'follow_up_question_id': 2, 'condition_operator': 'equals', 'condition_right_operand': 'yes'}, {'follow_up_question_id': 3, 'condition_operator': 'equals', 'condition_right_operand': 'yes'}, {'follow_up_question_id': 4, 'condition_operator': 'equals', 'condition_right_operand': 'no'}], 'is_follow_up': False, 'answer_value': 'yes', 'dropdown_data': None}, {'question_id': 2, 'text': 'What is the type of life insurance?', 'question_type': 'dropdown', 'position': 0, 'options': ['Term', 'Whole Life', 'UL', 'IUL', 'VUL', 'Other'], 'follow_up_questions': [], 'is_follow_up': True, 'answer_value': 'Term', 'dropdown_data': {'options': ['Term', 'Whole Life', 'UL', 'IUL', 'VUL', 'Other'], 'chosen_option_index': 0}}, {'question_id': 3, 'text': 'What is the amount?', 'question_type': 'number', 'position': 1, 'options': [], 'follow_up_questions': [], 'is_follow_up': True, 'answer_value': '77777', 'dropdown_data': None}, {'question_id': 4, 'text': 'What is the amount you are looking for?', 'question_type': 'number', 'position': 2, 'options': [], 'follow_up_questions': [], 'is_follow_up': True, 'answer_value': None, 'dropdown_data': None}, {'question_id': 5, 'text': 'Do you have any dependents?', 'question_type': 'yes_no', 'position': 2, 'options': [], 'follow_up_questions': [{'follow_up_question_id': 6, 'condition_operator': 'equals', 'condition_right_operand': 'yes'}], 'is_follow_up': False, 'answer_value': 'no', 'dropdown_data': None}, {'question_id': 6, 'text': 'Does any of your dependents have a chronic disease?', 'question_type': 'yes_no', 'position': 0, 'options': [], 'follow_up_questions': [{'follow_up_question_id': 6, 'condition_operator': 'equals', 'condition_right_operand': 'yes'}], 'is_follow_up': True, 'answer_value': None, 'dropdown_data': None}, {'question_id': 7, 'text': 'Which chronic disease does your dependent have?', 'question_type': 'dropdown', 'position': 0, 'options': ['Diabetes', 'Heart Disease', 'Cancer', 'Other'], 'follow_up_questions': [], 'is_follow_up': True, 'answer_value': None, 'dropdown_data': None}, {'question_id': 8, 'text': 'What is your favorite joke?', 'question_type': 'text', 'position': 3, 'options': [], 'follow_up_questions': [], 'is_follow_up': False, 'answer_value': None, 'dropdown_data': None}, {'question_id': 9, 'text': 'What is your profession?', 'question_type': 'text', 'position': None, 'options': [], 'follow_up_questions': [], 'is_follow_up': False, 'answer_value': 'Au! Au! Au!', 'dropdown_data': None}]}
